...
export const Header = () => {
    return (
        <header className="flex justify-between items-center sticky top-0 z-50 w-full h-56 py-5 border-b-2  bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
